#!/bin/bash
# Convert merged-v4-r7 → GGUF Q4_K_M. Runs on pod after merge.
set -e
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
cd "$ROOT"

MERGED_DIR="$ROOT/.orcai/ft-output/qwen7b-merged-v4-r7"
F16_GGUF="$ROOT/.orcai/ft-output/qwen7b-ft-v4-r7-f16.gguf"
Q4_GGUF="$ROOT/.orcai/ft-output/qwen7b-ft-v4-r7-Q4_K_M.gguf"
