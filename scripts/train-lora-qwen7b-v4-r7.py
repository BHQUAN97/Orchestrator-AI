...
OUTPUT_DIR = ".orcai/ft-output/qwen7b-lora-v4-r7"
TRAINING_FILES = [
    ...
    ".orcai/training/r7-patches.jsonl",  # R7: 15 Claude-Opus gold answers for R6 bench failures
]
