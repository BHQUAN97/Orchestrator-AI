"""Merge Qwen 7B LoRA v2 adapter into base — Round 5.5 version."""
import torch
...
ADAPTER_PATH = ".orcai/ft-output/qwen7b-lora-v2"
MERGED_PATH = ".orcai/ft-output/qwen7b-merged-v2"
...
def main():
    ...
    print(f"[merge] loading base model {BASE_MODEL} on CPU (DoRA needs extra VRAM, fits RAM easy)...")
