...
class AgentLoop {
   ...
   *
   * Alias cu _applyRagIfLocal giu lai cho backwards-compat.
   */
  async _applyRagIfNeeded() {
  ...
  // Backwards-compat alias — ten cu van work.
  _applyRagIfLocal() { return this._applyRagIfNeeded(); }
