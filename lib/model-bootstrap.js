...
class ModelBootstrap {
  ...
  _loadModel(modelId) {
    try {
      // context-length 8192: du cho system prompt day du ma khong overflow
      // GTX 1060 6GB: 7B Q4_K_M ~4.5GB VRAM, con ~1.5GB cho 8K context OK
      spawn(this.lmsCli, ['load', modelId, '--context-length', '8192'], {
        detached: true,
        stdio: 'ignore',
        windowsHide: true
      }).unref();
