...
const ROLE_PERMISSIONS = {
  ...
  'architect': {
    level: 'execute',
    allowed: ['read_file', 'write_file', 'edit_file', 'edit_files', 'list_files', 'search_files', 'glob', 'execute_command', 'web_fetch', 'web_search', 'spawn_subagent', 'spawn_team', 'decompose_task', 'read_mcp_resource', 'ask_user_question', 'todo_write', 'todo_list', 'memory_save', 'memory_recall', 'memory_list', 'create_skill', 'task_complete'],
    limits: {
  ...
  'reviewer': {
    level: 'read',
    allowed: ['read_file', 'list_files', 'search_files', 'glob', 'execute_command', 'web_fetch', 'web_search', 'read_mcp_resource', 'ask_user_question', 'todo_write', 'todo_list', 'memory_recall', 'memory_list', 'task_complete'],
